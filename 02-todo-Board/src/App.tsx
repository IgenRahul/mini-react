          ...
          .map((task) => (
            ...
            >
              ...
              <div className="flex justify-evenly mt-4">
                {status !== "todo" && (
                  <button
                    className="min-w-1/4 ml-2 text-sm font-extrabold px-2 py-1 bg-blue-500 text-white rounded hover:bg-blue-600"
                    onClick={() => {
                      setTasks((tasks) =>
                        tasks.map((t) =>
                          t.id === task.id
                ...
                <button
                  className="min-w-1/4 ml-2 text-sm font-bold px-2 py-1 bg-red-500  text-white rounded hover:bg-red-600"
                  onClick={() => {
                ...
                {status !== "done" && (
                  <button
                    className="min-w-1/4 ml-2 text-sm font-extrabold px-3 py-1 bg-green-500  text-white rounded hover:bg-green-600"
                    onClick={() => {
                      setTasks((tasks) =>
                        tasks.map((t) =>
                          t.id === task.id
